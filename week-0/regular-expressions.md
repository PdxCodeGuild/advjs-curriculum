...
- [MDN - Regular Expressions in JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions)
- [Node School workshop - regex-adventure](https://github.com/workshopper/regex-adventure)
